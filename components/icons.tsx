...
export const GiftIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.875c-1.82 0-3.413.918-4.43 2.375m0 0H3.75v-.375c0-1.036.84-1.875 1.875-1.875h1.25A3.375 3.375 0 0112 4.875v0-2.25m0 2.25A3.375 3.375 0 0017.625 8.25H20.25v-.375c0-1.036-.84-1.875-1.875-1.875h-1.25A3.375 3.375 0 0012 4.875z" />
    </svg>
);
